 ...
 * - [RELEASE_LATEST_TAG]: Release latest tag. Presented as *vMINOR.MAJOR.PATCH* syntax. Generated by CI/CD pipeline.
...
enum class AppBaseProperty(
	...
	/**
	 * Release latest tag. Presented as *vMINOR.MAJOR.PATCH* syntax. Generated by CI/CD pipeline. Default value: *UNKNOWN*.
	 */
	RELEASE_LATEST_TAG("release.latest-tag"),
